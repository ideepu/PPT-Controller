...
public class BluetoothDevices extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> pairedDevicesArrayAdapter =
                new ArrayAdapter<String>(this, R.layout.activity_bluetooth_first);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.activity_bluetooth_first);
        ...
        ListView newDevicesListView = (ListView) findViewById(R.id.listViewother);
    ...
    private void doDiscovery() {
        ...
        if (!mBtAdapter.isEnabled()) {
            ...
            makeVisible.putExtra(BluetoothAdapter.EXTRA_DISCOVERABLE_DURATION, 300);
            ...
            startActivityForResult(makeVisible, 0);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener
        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            Intent intent = new Intent(BluetoothDevices.this, BluetoothCommandSerivce.class);
